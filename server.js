    ...
    app.post('/download', async (req, res) => {
        try {
            ...
            if (existsSync(`./public/${filename}`)) {
                ...
                exec(`spotdl download ${url} --bitrate 320k --output public --lyrics musixmatch`, (err, stdout, stderr) => {
            ...
            res.json(JSON.stringify({status: "failed", reason: "A unexpected error"}))
        }
